...
<div className="  flex w-full sm:w-1/2  flex-col  items-start space-between gap-2 text-white ">
    <h2 className=" text-[2rem] sm:text-[2.6rem] mb-[0.25em]  font-sans text-white">
        Transforming <br className='block md:hidden'/> your <br className=' hidden sm:block'/>
        <span className="font-bold"> ideas into <br className='md:hidden'/> reality</span>
      </h2>
        <p className=" text-[0.8rem]  sm:text-[0.9rem]  text-white ">
...
<div className=" flex w-full sm:w-2/3 items-center sm:justify-end  h-[13rem]   mt-[2rem]  sm:mt-0 ">
  <div className="  flex  items-center justify-center mx-auto h-[85%] w-2/3 sm:w-1/3 rounded-full border-2 border-white">
  <p className=" text-[1rem] sm:text-[1rem] h-fit  max-w-[50%] text-center text-white ">
  Let&apos;s Work Together!
  </p>
  </div>
</div>
