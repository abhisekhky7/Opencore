...
export default function MainTitle() {
  return (
    <div className=''>
        ...
        <p className={` text-[2rem] text-center sm:text-[3rem] text-myBlue font-bold font-sans `}>
     ...
     <div className=""> 
      <p className=" text-myLightBlue font-medium text-[1rem] text-center sm:text-[1.2rem] " >
